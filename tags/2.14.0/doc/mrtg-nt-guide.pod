...
http://oss.oetiker.ch/mrtg/pub Look for mrtg-2.14.0.zip
...
Unzip MRTG to C:\mrtg-2.14.0 on the Windows machine of your choice.
...
and go into F<c:\mrtg-2.14.0\bin>. Type:
...
Get to a cmd prompt and change to the F<c:\mrtg-2.14.0\bin> directory. Type the
following command:
...
results by going into the F<c:\mrtg-2.14.0\bin> directory and typing:
