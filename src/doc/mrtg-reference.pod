...
mrtg-reference - MRTG 2.16.4 configuration reference
...
Currently, only UNIX domain sockets are supported, and you should note that
using RRDCached mode will disable all Threshold checking normally done
by MRTG.
