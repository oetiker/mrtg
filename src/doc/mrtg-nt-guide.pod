...
mrtg-nt-guide - The MRTG 2.17.2 Windows Installation Guide
...
mrtg-2.17.2.zip or better. The archive also contains a precompiled copy of
...
Unzip MRTG to C:\mrtg-2.17.2 on the Windows machine of your choice.
...
and go into F<c:\mrtg-2.17.2\bin>. Type:
...
Get to a cmd prompt and change to the F<c:\mrtg-2.17.2\bin> directory. Type the
following command:
...
results by going into the F<c:\mrtg-2.17.2\bin> directory and typing:
...
Copy B<srvany.exe> and B<instsrv.exe> to c:\mrtg-2.17.2\bin\ (your MRTG bin directory).
...
following content into it:
 ...
 "AppParameters"="c:\\mrtg-2.17.2\\bin\\mrtg --logging=eventlog c:\\mrtg-2.17.2\\bin\\mrtg.cfg"
 "AppDirectory"="c:\\mrtg-2.17.2\\bin\\"
