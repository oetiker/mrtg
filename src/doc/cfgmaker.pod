...
# -*- mode: Perl -*-
##################################################################
# MRTG 2.11.1  -- Config file creator
##################################################################
...
";
                $default_pagetop_directive .= "   <TR><TD>Port Name:</TD>  <TD>$if_port_name</TD></TR>\n" if defined $if_port_name;
                $default_pagetop_directive .= "   <TR><TD>Max Speed:</TD>  <TD>$if_speed_str</TD></TR>\n";
...
cfgmaker - Creates mrtg.cfg files (for mrtg-2.11.1)
