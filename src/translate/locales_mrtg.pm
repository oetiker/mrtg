...
###      => Gleydson Mazoli da Silva <gleydson@debian.org> (AtualizaÃ§Ã£o)
###      Bulgarian/Áúëãàğñêè
###      => Yovko Lambrev <yovko@sdf.lonestar.org>
###      catalan/CatalÃ 
###      => LLuÃ­s Gras <lluis@seccat.com>
...
###         and StÃ©phane Marzloff <secrer@le-bar.fdn.fr>
###      Galician/Galego
...
# Belarusian/Ğ±ĞµĞ»Ğ°Ñ€ÑƒÑĞºĞ°Ñ
   ...
   "Ğ‘ĞµĞ»Ğ°Ñ€ÑƒÑĞºÑ– Ğ¿ĞµÑ€Ğ°ĞºĞ»Ğ°Ğ´:
				<a href=\"http://375gnu.wordpress.com\">Ğ“Ğ»ĞµĞ± Ğ’Ğ°Ğ»Ğ¾ÑˆĞºĞ°</a>
...
# Czechutf8/ÄŒesky
   'czechutf8' =>
		    "ÄŒeskÃ½ pÅ™eklad do UTF-8 pÅ™ipravil
...
sub belarusian
{
  ...
  (  
     'iso-8859-1'                             => 'utf-8',
     'Maximal 5 Minute Incoming Traffic'      => 'ĞĞ°Ğ¹Ğ±Ğ¾Ğ»ÑŒÑˆÑ‹ ÑĞ²Ğ°Ñ…Ğ¾Ğ´Ğ½Ñ‹ Ñ‚Ñ€Ğ°Ñ„Ñ–Ğº Ğ·Ğ° 5 Ñ…Ğ²Ñ–Ğ»Ñ–Ğ½',
     'Maximal 5 Minute Outgoing Traffic'      => 'ĞĞ°Ğ¹Ğ±Ğ¾Ğ»ÑŒÑˆÑ‹ Ğ²Ñ‹Ñ…Ğ¾Ğ´Ğ½Ñ‹ Ñ‚Ñ€Ğ°Ñ„Ñ–Ğº Ğ·Ğ° 5 Ñ…Ğ²Ñ–Ğ»Ñ–Ğ½',
     'the device'                             => 'Ğ¿Ñ€Ñ‹Ğ»Ğ°Ğ´Ğ°',
     'The statistics were last updated(.*)'   => 'ĞĞ¿Ğ¾ÑˆĞ½Ñ– Ñ€Ğ°Ğ· ÑÑ‚Ğ°Ñ‚Ñ‹ÑÑ‚Ñ‹ĞºĞ° Ğ°Ğ±Ğ½Ğ°ÑĞ»ÑĞ»Ğ°ÑÑ: $1',
     ' Average\)'                             => ')',
     'Average'                                => 'ÑĞ¿Ğ°ÑÑÑ€ÑĞ´Ğ½ĞµĞ½Ñ‹',
     'Max'                                    => 'Ğ½Ğ°Ğ¹Ğ±Ğ¾Ğ»ÑŒÑˆÑ‹',
     'Current'                                => 'Ğ±ÑĞ³ÑƒÑ‡Ñ‹',
     'version'                                => 'Ğ²ÑÑ€ÑÑ–Ñ',
     '`Daily\' Graph \((.*) Minute'           => 'Ğ“Ñ€Ğ°Ñ„Ñ–Ğº Ñ‚Ñ€Ğ°Ñ„Ñ–ĞºÑƒ Ğ·Ğ° ÑÑƒÑ‚ĞºÑ– (Ğ·Ğ° $1 Ñ…Ğ²Ñ–Ğ»Ñ–Ğ½ ',
     '`Weekly\' Graph \(30 Minute'            => 'Ğ“Ñ€Ğ°Ñ„Ñ–Ğº Ñ‚Ñ€Ğ°Ñ„Ñ–ĞºÑƒ Ğ·Ğ° Ñ‚Ñ‹Ğ´Ğ·ĞµĞ½ÑŒ (Ğ·Ğ° 30 Ñ…Ğ²Ñ–Ğ»Ñ–Ğ½ ',
     '`Monthly\' Graph \(2 Hour'              => 'Ğ“Ñ€Ğ°Ñ„Ñ–Ğº Ñ‚Ñ€Ğ°Ñ„Ñ–ĞºÑƒ Ğ·Ğ° Ğ¼ĞµÑÑÑ† (Ğ·Ğ° 2 Ğ³Ğ°Ğ´Ğ·Ñ–Ğ½Ñ‹ ',
     '`Yearly\' Graph \(1 Day'                => 'Ğ“Ñ€Ğ°Ñ„Ñ–Ğº Ñ‚Ñ€Ğ°Ñ„Ñ–ĞºÑƒ Ğ·Ğ° Ğ³Ğ¾Ğ´ (Ğ·Ğ° 1 Ğ´Ğ·ĞµĞ½ÑŒ ', 
     'Incoming Traffic in (\S+) per Second'   => 'Ğ£Ğ²Ğ°Ñ…Ğ¾Ğ´Ğ½Ñ‹ Ñ‚Ñ€Ğ°Ñ„Ñ–Ğº $1 Ğ·Ğ° ÑÑĞºÑƒĞ½Ğ´Ñƒ',
     'Outgoing Traffic in (\S+) per Second'   => 'Ğ’Ñ‹Ñ…Ğ¾Ğ´Ğ½Ñ‹ Ñ‚Ñ€Ğ°Ñ„Ñ–Ğº $1 Ğ·Ğ° ÑÑĞºÑƒĞ½Ğ´Ñƒ',
     'Incoming Traffic in (\S+) per Minute'   => 'Ğ£Ğ²Ğ°Ñ…Ğ¾Ğ´Ğ½Ñ‹ Ñ‚Ñ€Ğ°Ñ„Ñ–Ğº $1 Ğ·Ğ° Ñ…Ğ²Ñ–Ğ»Ñ–Ğ½Ñƒ',
     'Outgoing Traffic in (\S+) per Minute'   => 'Ğ’Ñ‹Ñ…Ğ¾Ğ´Ğ½Ñ‹ Ñ‚Ñ€Ğ°Ñ„Ñ–Ğº $1 Ğ·Ğ° Ñ…Ğ²Ñ–Ğ»Ñ–Ğ½Ñƒ',
     'Incoming Traffic in (\S+) per Hour'     => 'Ğ£Ğ²Ğ°Ñ…Ğ¾Ğ´Ğ½Ñ‹ Ñ‚Ñ€Ğ°Ñ„Ñ–Ğº $1 Ğ·Ğ° Ğ³Ğ°Ğ´Ğ·Ñ–Ğ½Ñƒ',
     'Outgoing Traffic in (\S+) per Hour'     => 'Ğ’Ñ‹Ñ…Ğ¾Ğ´Ğ½Ñ‹ Ñ‚Ñ€Ğ°Ñ„Ñ–Ğº $1 Ğ·Ğ° Ğ³Ğ°Ğ´Ğ·Ñ–Ğ½Ñƒ',
     'at which time (.*) had been up for(.*)' => 'ĞºĞ°Ğ»Ñ– $1 Ğ¿Ñ€Ğ°Ñ†Ğ°Ğ²Ğ°Ñ $2',
     '(\S+) per minute'			      => '$1 Ğ·Ğ° Ñ…Ğ²Ñ–Ğ»Ñ–Ğ½Ñƒ',
     '(\S+) per hour'			      => '$1 Ğ·Ğ° Ğ³Ğ°Ğ´Ğ·Ñ–Ğ½Ñƒ',    
     '(.+)/s$'                                => '$1/Ñ',
     '(.+)/min'                               => '$1/Ñ…Ğ²',
     '(.+)/h$'                                => '$1/Ğ³',
     '([kMG]?)([bB])/s'                       => '$1$2/Ñ',
     ...
     'In'                                     => 'Ğ£Ğ²Ğ°Ñ…Ğ¾Ğ´Ğ½Ñ‹',
     'Out'                                    => 'Ğ’Ñ‹Ñ…Ğ¾Ğ´Ğ½Ñ‹',
     'Percentage'                             => 'ĞĞ´ÑĞ¾Ñ‚ĞºÑ–',
     'Ported to OpenVMS Alpha by'             => 'ĞŸĞµÑ€Ğ°Ğ½Ğ¾Ñ Ğ½Ğ° OpenVMS:', 
     'Ported to WindowsNT by'                 => 'ĞŸĞµÑ€Ğ°Ğ½Ğ¾Ñ Ğ½Ğ° WindowsNT:',
     'and'                                    => 'Ñ–',
     '^GREEN'                                 => 'Ğ—Ğ¯Ğ›ĞĞĞ«',
     'BLUE'                                   => 'Ğ¡Ğ†ĞĞ†',
     'DARK GREEN'                             => 'Ğ¦ĞĞœĞĞĞ—Ğ¯Ğ›ĞĞĞ«',
     'MAGENTA'                                => 'Ğ Ğ£Ğ–ĞĞ’Ğ«',
     'AMBER'                                  => 'Ğ‘Ğ£Ğ Ğ¨Ğ¢Ğ«ĞĞĞ’Ğ«'
  );
...
%wday = 
    (
      'Sunday'    => 'ĞÑĞ´Ğ·ĞµĞ»Ñ',     'Sun' => 'ĞĞ´',
      'Monday'    => 'ĞŸĞ°Ğ½ÑĞ´Ğ·ĞµĞ»Ğ°Ğº',  'Mon' => 'ĞŸĞ½',
      'Tuesday'   => 'ĞÑÑ‚Ğ¾Ñ€Ğ°Ğº',     'Tue' => 'ĞÑ',
      'Wednesday' => 'Ğ¡ĞµÑ€Ğ°Ğ´Ğ°',      'Wed' => 'Ğ¡Ñ€',
      'Thursday'  => 'Ğ§Ğ°Ñ†ÑŒĞ²ĞµÑ€',     'Thu' => 'Ğ§Ñ†',
      'Friday'    => 'ĞŸÑÑ‚Ğ½Ñ–Ñ†Ğ°',     'Fri' => 'ĞŸÑ‚',
      'Saturday'  => 'Ğ¡ÑƒĞ±Ğ¾Ñ‚Ğ°',      'Sat' => 'Ğ¡Ğ±' 
    );

%month = 
    (
      'January'   => 'Ğ¡Ñ‚ÑƒĞ´Ğ·ĞµĞ½ÑŒ',  'February'  => 'Ğ›ÑÑ‚Ñ‹' ,       'March'     => 'Ğ¡Ğ°ĞºĞ°Ğ²Ñ–Ğº',
      'Jan'       => 'Ğ¡Ñ‚Ñƒ',       'Feb'       => 'Ğ›ÑÑ‚',         'Mar'       => 'Ğ¡Ğ°Ğº',
      'April'     => 'ĞšÑ€Ğ°ÑĞ°Ğ²Ñ–Ğº',  'May'       => 'Ğ¢Ñ€Ğ°Ğ²ĞµĞ½ÑŒ',     'June'      => 'Ğ§ÑÑ€Ğ²ĞµĞ½ÑŒ', 
      'Apr'       => 'ĞšÑ€Ğ°',       'May'       => 'Ğ¢Ñ€Ğ°',         'Jun'       => 'Ğ§ÑÑ€',
      'July'      => 'Ğ›Ñ–Ğ¿ĞµĞ½ÑŒ',    'August'    => 'Ğ–Ğ½Ñ–Ğ²ĞµĞ½ÑŒ',     'September' => 'Ğ’ĞµÑ€Ğ°ÑĞµĞ½ÑŒ', 
      'Jul'       => 'Ğ›Ñ–Ğ¿',       'Aug'       => 'Ğ–Ğ½Ñ–',         'Sep'       => 'Ğ’ĞµÑ€', 
      'October'   => 'ĞšĞ°ÑÑ‚Ñ€Ñ‹Ñ‡Ğ½Ñ–Ğº','November'  => 'Ğ›Ñ–ÑÑ‚Ğ°Ğ¿Ğ°Ğ´',    'December'  => 'Ğ¡ÑŒĞ½ĞµĞ¶Ğ°Ğ½ÑŒ', 
      'Oct'       => 'ĞšĞ°Ñ',       'Nov'       => 'Ğ›Ñ–Ñ',         'Dec'       => 'Ğ¡ÑŒĞ½' 
    );
...
return "" unless defined $string;
  ...
  (  
     'iso-8859-1'                             => 'utf-8',
     'Maximal 5 Minute Incoming Traffic'      => 'MaximÃ¡lnÃ­ 5 minutovÃ½ pÅ™Ã­chozÃ­ tok',
     'Maximal 5 Minute Outgoing Traffic'      => 'MaximÃ¡lnÃ­ 5 minutovÃ½ odchozÃ­ tok',
     'the device'                             => 'zaÅ™Ã­zenÃ­',
     'The statistics were last updated(.*)'   => 'PoslednÃ­ aktualizace statistiky:$1',
     ' Average\)'                             => ' prÅ¯mÄ›r)',
     'Average'                                => 'PrÅ¯m.',
     'Max'                                    => 'Max.',
     'Current'                                => 'Akt.',
     'version'                                => 'verze',
     '`Daily\' Graph \((.*) Minute'           => 'DennÃ­ graf ($1 minutovÃ½',
     '`Weekly\' Graph \(30 Minute'            => 'TÃ½dennÃ­ graf (30 minutovÃ½' ,
     '`Monthly\' Graph \(2 Hour'              => 'MÄ›sÃ­ÄnÃ­ graf (2 hodinovÃ½',
     '`Yearly\' Graph \(1 Day'                => 'RoÄnÃ­ graf (1 dennÃ­', 
     'Incoming Traffic in (\S+) per Second'   => 'PÅ™Ã­chozÃ­ tok v $1 za sec.',
     'Outgoing Traffic in (\S+) per Second'   => 'OdchozÃ­ tok v $1 za sec.',
     'at which time (.*) had been up for(.*)' => 'od poslednÃ­ho restartu $1 ubÄ›hlo: $2',
     #'([kMG]?)([bB])/s'                       => '\$1\$2/s',
     #'([kMG]?)([bB])/min'     	      	      => '\$1\$2/min',
     #'([kMG]?)([bB])/h'                       => '$1$2/h',
     'Bits'                                   => 'bitech',
...
%wday = 
    (
      'Sunday'    => 'NedÄ›le',		'Sun' => 'Ne',
      'Monday'    => 'PondÄ›lÃ­',		'Mon' => 'Po',
      'Tuesday'   => 'ÃšterÃ½',		'Tue' => 'Ãšt',
      'Wednesday' => 'StÅ™eda',		'Wed' => 'St',
      'Thursday'  => 'ÄŒtvrtek',		'Thu' => 'ÄŒt',
      'Friday'    => 'PÃ¡tek',		'Fri' => 'PÃ¡',
      'Saturday'  => 'Sobota',		'Sat' => 'So' 
    );

%month = 
    (
 'January' => 'Leden',   'February' => 'Ãšnor',      'March'     => 'BÅ™ezen',
 'Jan'     => 'Leden',   'Feb'      => 'Ãšnor',      'Mar'       => 'BÅ™ezen',
 'April'   => 'Duben',   'May'      => 'KvÄ›ten',    'June'      => 'ÄŒerven',
 'Apr'     => 'Duben',   'May'      => 'KvÄ›ten',    'Jun'       => 'ÄŒerven',
 'July'    => 'ÄŒervenec','August'   => 'Srpen',     'September' => 'ZÃ¡Å™Ã­',
 'Jul'     => 'ÄŒervenec','Aug'      => 'Srpen',     'Sep'       => 'ZÃ¡Å™Ã­', 
 'October' => 'Å˜Ã­jen',   'November' => 'Listopad',  'December'  => 'Prosinec', 
 'Oct'     => 'Å˜Ã­jen',   'Nov'      => 'Listopad',  'Dec'       => 'Prosinec' 
    );
...
return "" unless defined $string;
  ...
  (  
     ...
     'Current'                                => 'ôÅËÕİÉÊ',
     'version'                                => '×ÅÒÓÉÑ',
     '`Daily\' Graph \((.*) Minute'           => 'óÕÔÏŞÎÙÊ ÇÒÁÆÉË (ÓÒÅÄÎÅÅ ÚÁ $1 ÍÉÎÕÔ',
     '`Weekly\' Graph \(30 Minute'            => 'îÅÄÅÌØÎÙÊ ÇÒÁÆÉË (ÓÒÅÄÎÅÅ ÚÁ 30 ÍÉÎÕÔ' ,
     '`Monthly\' Graph \(2 Hour'              => 'íÅÓÑŞÎÙÊ ÇÒÁÆÉË  (ÓÒÅÄÎÅÅ ÚÁ 2 ŞÁÓÁ',
...
return "" unless defined $string;
  ...
  (  
     ...
     'Current'                                => 'Ñåé÷àñ',
     'version'                                => 'âåğñèÿ',
     '`Daily\' Graph \((.*) Minute'           => 'Ñóòî÷íûé ãğàôèê (ñğåäíåå çà $1 ìèíóò',
     '`Weekly\' Graph \(30 Minute'            => 'Íåäåëüíûé ãğàôèê (ñğåäíåå çà 30 ìèíóò' ,
     '`Monthly\' Graph \(2 Hour'              => 'Ìåñÿ÷íûé ãğàôèê  (ñğåäíåå çà 2 ÷àñà',
     '`Yearly\' Graph \(1 Day'                => 'Ãîäîâîé ãğàôèê (ñğåäíåå çà 1 äåíü', 
