...
mrtg-nt-guide - The MRTG 2.16.0 Windows Installation Guide
...
mrtg-2.16.0.zip or better. The archive also contains a precompiled copy of
...
Unzip MRTG to C:\mrtg-2.16.0 on the Windows machine of your choice.
...
and go into F<c:\mrtg-2.16.0\bin>. Type:
...
Get to a cmd prompt and change to the F<c:\mrtg-2.16.0\bin> directory. Type the
following command:
...
results by going into the F<c:\mrtg-2.16.0\bin> directory and typing:
...
to your mrtg.cfg file and start it with:
 ...
 start /Dc:\mrtg-2.16.0\bin wperl mrtg --logging=eventlog mrtg.cfg
