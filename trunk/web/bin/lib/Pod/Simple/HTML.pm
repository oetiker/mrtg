...
$Linearization_Limit = 120 unless defined $Linearization_Limit;
 # headings/items longer than that won't get an <a id="...">
...
sub _add_top_anchor {
  my($self, $text_r) = @_;
  unless($$text_r and $$text_r =~ m/id=['"]___top['"]/) { # a hack
    $$text_r .= "<a id='___top' class='dummyTopAnchor' ></a>\n";
  }
  return;
}
...
sub section_name_tidy {
  my($self, $section) = @_;
  $section =~ tr/ /_/;
  $section =~ s/[^0-9a-z]/_/ig; # drop crazy characters
